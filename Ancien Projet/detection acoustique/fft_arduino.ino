 ...
 *  Envoi par port COM pour detection
 */
  ...
  for(x=0; x<8; x++) {
    ...
    for(i=1; i<10; i++) { // Get range of prior 10 frames
      ...
      for(int l=0; l<FFT_N/2; l++){
          //if(spectrum[l] != 0){
            Serial.print((l*9600)/FFT_N);//print frequency
            Serial.print(",");
            Serial.print(spectrum[l]);  //print amplitude
            //if( l < FFT_N/2 - 1) Serial.print(",");
            //else Serial.println("");
            Serial.println("");
          //}
        }
